...
FOR %%c IN (Tools\Decoding\*.wem) DO ("Tools\vgmstream-cli.exe" -o "%%c2" "%%c" & REN "%%c2")
FOR %%d IN (Tools\Decoding\*.wav) DO ("Tools\ffmpeg.exe" -i "%%d" -acodec libmp3lame -b:a 320k -ac 2 -ar 44100 "MP3\%%~nd.mp3" & DEL "%%d")
